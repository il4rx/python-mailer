...
message_div = input(Fore.RED + "[+] " + Style.RESET_ALL + "Message > ")
...
myTable.add_row([platform.node(), sender_email, receiver_email, len(message_div), s])
print(myTable)
...
mailTest = MIMEText(email_html, "html")
